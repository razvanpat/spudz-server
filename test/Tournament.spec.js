...
//**************** Helpers *********************
	...
	describe('Tournament', function() {
		...
		xit('monitors match ends and creates a new round of matches when every match has ended', function() {
			...
			expect(Tournament.player1).to.equal(Tournament.playersSignedUp[0]);
			expect(Tournament.player2).to.equal(Tournament.playersSignedUp[2]);
		});

		xit('moves forward to next round any player without a match', function() {
			withConfiguredTournament();
			signUpPlayer('p1');
			signUpPlayer('p2');
			signUpPlayer('p3');
		...
		xit('notifies the player without a match that he advances', function() {
			withConfiguredTournament();
			signUpPlayer('p1');
			signUpPlayer('p2');
			signUpPlayer('p3');
